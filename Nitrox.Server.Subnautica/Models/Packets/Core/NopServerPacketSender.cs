...
{
    public ValueTask SendPacket<T>(T packet, PeerId peerId) where T : Packet => ValueTask.CompletedTask;
    ...
    public ValueTask SendPacketToOthers<T>(T packet, PeerId excludedPeerId) where T : Packet => ValueTask.CompletedTask;
}
