...
internal class SetIntroCinematicModeProcessor(PlayerService playerService) : AuthenticatedPacketProcessor<SetIntroCinematicMode>
{
    private readonly PlayerService playerService = playerService;

    public override void Process(SetIntroCinematicMode packet, NitroxServer.Player player)
    {
