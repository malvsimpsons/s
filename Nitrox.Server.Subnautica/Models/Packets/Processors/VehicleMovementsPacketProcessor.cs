...
internal sealed class VehicleMovementsPacketProcessor(PlayerService playerManager, EntityRegistry entityRegistry, SimulationOwnershipData simulationOwnershipData) : AuthenticatedPacketProcessor<VehicleMovements>
{
    ...
    public override void Process(VehicleMovements packet, NitroxServer.Player player)
    {
