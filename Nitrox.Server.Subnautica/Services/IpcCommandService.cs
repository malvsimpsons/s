...
/// </summary>
internal sealed class IpcCommandService(CommandService commandService, IServerPacketSender packetSender, ILogger<IpcCommandService> logger) : BackgroundService
{
    ...
    private readonly ILogger<IpcCommandService> logger = logger;
