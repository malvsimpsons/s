...
[TestClass]
public class IPacketProcessorTest
{
    [TestMethod]
    public void ClientPacketProcessorSanity()
    {
        typeof(ClientIPacketProcessor<>).Assembly.GetTypes()
                                       ...
                                       .ForEach(processor =>
                                       {
                                           ...
                                           Assert.IsTrue(processor.BaseType.IsAssignableToGenericType(typeof(ClientIPacketProcessor<>)), $"{processor} does not derive from ClientPacketProcessor!");
    ...
    public void AllPacketsAreHandled()
    {
        ...
        abstractProcessorTypes.AddRange(typeof(ClientIPacketProcessor<>)
                                        .Assembly.GetTypes()
                                        .Where(p => p.IsClass && p.IsAbstract && p.IsAssignableToGenericType(typeof(ClientIPacketProcessor<>))));
